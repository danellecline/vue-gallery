...
<script>
    ...
    export default {
        ...
        updated() {
            ...
            const added = this.difference(newChildren, this._oldChidren)
        ...
        methods: {
            ...
            buildFilterFunction(name) {
                ...
                this._filterlistener = this.$watch(() => { return this.map(this.list, (el, index) => this.options.getFilterData[name](el, index)); },
                    () => { this.iso._requestUpdate(); });
                return filter
            },
